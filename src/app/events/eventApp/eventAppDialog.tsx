...
const [userEntryData,setUserEntryData] = useState({eventID:'',applicantID:'',emailAddress:'', phoneNumber:''})
    ...
    function handleInputErrors(){
     try{
      ...
      document.getElementById(d.eventName+'confirm').showModal()
     }
...
<path stroke-linecap="round" stroke-linejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5"  />
    ...
    return(
          ...
          <input className="appearance-none block w-96 bg-gray-50 disabled:bg-gray-200 text-gray-700 border border-red-500 rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="eventAppEmail" name='emailAddress' onChange={handleStateChange}/>
          </div>
          <div className='text-start ml-4 mb-6'>
          <label className="block text-gray-700 text-xl font-semibold mb-2" for="eventCreatorName">Contact Information: </label>
          <input className="appearance-none block w-96 bg-gray-50 disabled:bg-gray-200 text-gray-700 border border-red-500 rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="eventAppEmail" name='phoneNumber' type='number' onChange={handleStateChange}></input>
          </div>
          <div className='text-start ml-4 mb-6'>
