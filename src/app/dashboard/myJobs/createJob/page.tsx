...
const [formData, setFormData] = useState({eventName:'',createDateStart:'',createDateEnd:'',createJob0:'',createJob1:'', createLoc0:'',createLoc:'', createWageType:'',createWageTypeVal:'',createDescription:''})
  return(
    <>
   <NavBar>
