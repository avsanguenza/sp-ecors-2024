    ...
    <>
      ...
      <ol class=" mt-10 flex items-center w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 sm:text-base dark:bg-white dark:border-pink-500 sm:p-4 sm:space-x-4 rtl:space-x-reverse">
          <li class="flex items-center text-pink-500 dark:text-pink-500">
              ...
              Job <span class="hidden sm:inline-flex sm:ms-2">Info</span>
          ...
          <li class="flex items-center">
              ...
              Project Skills <span class="hidden sm:inline-flex sm:ms-2">Info</span>
              <svg class="w-3 h-3 ms-2 sm:ms-4 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 10">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 9 4-4-4-4M1 9l4-4-4-4"/>
              </svg>
          </li>
...
return(
  ...
  <div id= "jobExperienceForm">
    ...
    <div className="mx-auto md:w-1/2 px-3 mb-6 md:mb-0">
    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name"> Project Skills Required </label>
  ...
  <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">DOCX or PDF</p>
    ...
    <div>
    <label class="mt-6 block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Budget </label>
