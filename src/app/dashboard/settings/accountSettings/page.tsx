...
<div class="ml-10 mt-10 md:flex">
        ...
        <h3 class="text-4xl font-bold text-gray-900 dark:text-white mb-[2rem]">Account Settings</h3>
        <hr class="h-px my-full bg-gray-200 border-0 dark:bg-gray-700 mb-4"/>
 ...
 Change Password      </button>
        ...
        <button type="button" class="text-white bg-red-700 hover:bg-red-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2" onClick={()=>openAppModal()}>
          ...
          <div className='flex min-h-full items-center justify-center p-8 text-center'>
            ...
            <hr class="h-px w-full my-8 bg-gray-200 border-0 dark:bg-gray-700"/>
                ...
                <div className=" mt-5 mx-auto text-center">
                    <button type="button" class="text-white bg-gray-200 hover:bg-gray-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2" onClick={()=>closeAppModal()} >
    
Cancel        </button>
                    <button type="button" class="text-white bg-red-700 hover:bg-red-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2" >
   Continue 
        </button>
                </div>
              </Dialog.Panel>
